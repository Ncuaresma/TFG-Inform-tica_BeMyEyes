...
{
    cv::Mat input = cv::imread("Imagenes/Prueba1.jpeg");//----------------ALGO PASA CON PRUEBA1.jpeg
    ...
    {
        cv::line(input, cv::Point(lines[i][2], lines[i][3]), cv::Point(lines[i][4], lines[i][5]), cv::Scalar(0, 255, 0), 5);
    }
