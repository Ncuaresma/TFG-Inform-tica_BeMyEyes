...
absl::Status RunMPPGraph() {
  ...
  while (grab_frames) {
    ...
    if (save_video) {
      ...
      //Lo que viene aqui es mostrar por pantalla la imagen(que es lo que esta abajo programado)
      //, pero a nosotros eso no nos interesa porque el que lo usa no ve(veremos si queremos 
      //mosrarlo por facillidad de explicar)
